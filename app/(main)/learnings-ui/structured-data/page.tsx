...
import { recipeSchema } from "@/app/api/learnings/structured-data/schema";

export default function StructuredDataPage() {
  const [dishName, setDishName] = useState("");

  const { submit, object, isLoading, error, stop } = useObject({ //useObject is a hook provided by ai sdk for structured data
    api: "/api/learnings/structured-data",
    schema: recipeSchema,
  });
